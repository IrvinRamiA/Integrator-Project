...
#ifndef DISPLAYTHREAD_H_
#define DISPLAYTHREAD_H_
#include "bsp_api.h"
#include "tx_api.h"
#include "hal_data.h"
#ifdef __cplusplus 
extern "C" void displayThread_entry(void);
#else 
extern void displayThread_entry(void);
#endif
#include "r_sci_spi.h"
#include "r_spi_api.h"
#include "r_icu.h"
...
extern TX_QUEUE gSetPointDisplayQueue;
extern TX_QUEUE gSpeedDisplayQueue;
extern TX_QUEUE gDutyCycleDisplayQueue;
#ifdef __cplusplus
} /* extern "C" */
#endif
#endif /* DISPLAYTHREAD_H_ */
