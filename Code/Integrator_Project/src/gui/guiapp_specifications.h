...
#define ID_WINDOW1 1
#define ID_SET_POINT 2
#define ID_NOMBRE 3
#define ID_SPEED 4
#define ID_DUTY_CYCLE 5
...
typedef struct WINDOW1_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT window1_nombre;
    GX_PROMPT window1_nombre_1;
    GX_PROMPT window1_nombre_2;
    GX_PROMPT window1_nombre_3;
    GX_PROMPT window1_nombre_4;
    GX_PROMPT window1_nombre_5;
    GX_PROMPT window1_speed;
    GX_PROMPT window1_nombre_6;
    GX_PROMPT window1_nombre_7;
    GX_PROMPT window1_nombre_8;
    GX_PROMPT window1_nombre_9;
