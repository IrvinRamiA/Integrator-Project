...
GX_PROMPT_PROPERTIES window1_setPoint_properties =
{
    ...
    GX_FONT_ID_NEWFONT2,                     /* font id                        */
    GX_COLOR_ID_BTN_TEXT,                    /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT                /* selected text color            */
};
GX_PROMPT_PROPERTIES window1_nombre_properties =
{
...
GX_PROMPT_PROPERTIES window1_nombre_1_properties =
{
...
GX_PROMPT_PROPERTIES window1_nombre_2_properties =
{
...
GX_PROMPT_PROPERTIES window1_nombre_3_properties =
{
...
GX_PROMPT_PROPERTIES window1_nombre_4_properties =
{
...
GX_PROMPT_PROPERTIES window1_nombre_5_properties =
{
...
GX_PROMPT_PROPERTIES window1_nombre_6_properties =
{
...
GX_PROMPT_PROPERTIES window1_nombre_7_properties =
{
...
GX_PROMPT_PROPERTIES window1_nombre_8_properties =
{
...
GX_PROMPT_PROPERTIES window1_nombre_9_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window1_nombre_9_define =
{
    "nombre_9",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_NOMBRE,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {4, 51, 78, 70},                         /* widget size                    */
    &window1_dutyCycle_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_nombre_9), /* control block        */
    (void *) &window1_nombre_9_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_nombre_8_define =
{
    "nombre_8",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_NOMBRE,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {109, 176, 207, 195},                    /* widget size                    */
    &window1_nombre_9_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_nombre_8), /* control block        */
    (void *) &window1_nombre_8_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_nombre_7_define =
{
    "nombre_7",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_NOMBRE,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {109, 200, 207, 219},                    /* widget size                    */
    &window1_nombre_8_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_nombre_7), /* control block        */
    (void *) &window1_nombre_7_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_nombre_6_define =
{
    "nombre_6",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_NOMBRE,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {6, 201, 104, 220},                      /* widget size                    */
    &window1_nombre_7_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_nombre_6), /* control block        */
    (void *) &window1_nombre_6_properties    /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window1_speed_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {90, 75, 169, 94},                       /* widget size                    */
    &window1_nombre_6_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_speed), /* control block           */
    (void *) &window1_speed_properties       /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_nombre_5_define =
{
    "nombre_5",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_NOMBRE,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {6, 176, 104, 195},                      /* widget size                    */
    &window1_speed_define,                   /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_nombre_5), /* control block        */
    (void *) &window1_nombre_5_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_nombre_4_define =
{
    "nombre_4",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_NOMBRE,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {6, 152, 104, 171},                      /* widget size                    */
    &window1_nombre_5_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_nombre_4), /* control block        */
    (void *) &window1_nombre_4_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_nombre_3_define =
{
    "nombre_3",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_NOMBRE,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {5, 126, 103, 145},                      /* widget size                    */
    &window1_nombre_4_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_nombre_3), /* control block        */
    (void *) &window1_nombre_3_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_nombre_2_define =
{
    "nombre_2",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_NOMBRE,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {4, 75, 78, 94},                         /* widget size                    */
    &window1_nombre_3_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_nombre_2), /* control block        */
    (void *) &window1_nombre_2_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_nombre_1_define =
{
    "nombre_1",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_NOMBRE,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {4, 99, 78, 118},                        /* widget size                    */
    &window1_nombre_2_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_nombre_1), /* control block        */
    (void *) &window1_nombre_1_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_nombre_define =
{
    "nombre",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_NOMBRE,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {4, 21, 236, 40},                        /* widget size                    */
    &window1_nombre_1_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_nombre), /* control block          */
    (void *) &window1_nombre_properties      /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window1_setPoint_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {90, 50, 169, 69},                       /* widget size                    */
    &window1_nombre_define,                  /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window1_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &window1_setPoint_define,                /* child widget                   */
    0,                                       /* control block                  */
